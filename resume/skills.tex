...
\cvsubsection{Programming fluency \& Software familiarity}
	\begin{cvskills}
		\cvskill{Languages}{Python (Scikit-Learn, Tensorflow, Boto3, Numpy, Scipy, Pandas, Geopandas, Matplotlib, SQLAlchemy), PostgreSQL, PostGIS, Julia, Shell, FORTRAN90, HTML/CSS}
		\cvskill{Software}{AWS (EC2, ECS, S3, Glacier, Cloudwatch, Dynamodb, RDS, Kinesis, Lambda), Docker, Git, Jupyter-Framework, Continuous Integration (Jenkins, Travis), MongoDB}
...
\cvsubsection{Open source software development}
    \begin{cvskillsy}
		\cvskill{\hspace{0.2cm}pythonmaps}{pythonmaps is a project to produce eye catching geospatial data visualisations using python. I have 24,100 followers on twitter, where I share these visualisations and articles outlining how to generate these visualisations. I will be delivering a workshop at the scipy conference in Austin this year where I will outline how to correctly visualise geospatial data. I have also recently partnered with Locate Press LLC to produce a geospatial data visualisation book.}
